...
interface MultipleSelectProps {
    setDiagnosisCode: React.Dispatch<React.SetStateAction<string[]>>;
...
const MultipleSelect = ({diagnosisCode, setDiagnosisCode}: MultipleSelectProps) => {
  ...
  React.useEffect(() => {
    diagnosis.getAll().then(res => setCodes(res.map(r => r.code)));
  }, []);
